...
// View the carriage fully or partially assembled or individual parts
View = 4; // [0: assembled_carriage, 1: assembled_carriage_with_plates, 2: assembled_wheel_support, 3: assembled_frame, 4: parts]
// Show the profile in assembled views 
Show_Profile = 1; // [0: no, 1: yes]
// Choose individual parts to compute
Part = 4; // [0: frame, 1: wheel_support, 2: adjustment_screw_saddle, 3: adjustment_screw_bracket, 4: side_1_panel, 5: side_2_panel]
